...
def run_settlement(months=1):
    ...
    for _ in range(months):
        ...
        # 2. 中途採用（自動補充）計算 (離職者の約半分が戻る：2対1の比率)
        mid = int(res * 0.5)
